    ...
    public partial class frmReceipt : Form
    {
        ...
        public void loadReport(string pcash,string pchange)
        {
            ...
            try
            {
                ...
                cn.Open();
                da.SelectCommand = new SqlCommand("select c.id, c.transno ,c.pcode,c.price ,c.qty,c.disc,c.total ,c.sdate ,c.status,p.pdesc from tblCart as c inner join tblProduct as p on p.pcode = c.pcode where c.transno like '"+f.lblTransno.Text+"'", cn);
